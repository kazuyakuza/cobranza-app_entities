...
**Project**: Cobranza App – Entities Library (TypeScript SSOT data models for multi-tenant SaaS debt/payment reconciliation).
...
- **Agent**: architect
- Plan README rewrite: replace base template content with Cobranza App Entities Library specifics.
