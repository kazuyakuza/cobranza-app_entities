...
These problems result in bugs, wasted effort, and unreliable data across the Conciliador de Pagos platform.

## Product Vision

The **Entities Library** (`@conciliador/entities`) is the **Single Source of Truth (SSOT)** for all data models in the Conciliador de Pagos ecosystem. It provides a single, versioned TypeScript package that:
...
- All consuming projects reference `@conciliador/entities` for their data model needs.
